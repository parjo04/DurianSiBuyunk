<?php
/**
 * Simple Reports page for Garut branch
 */
...
try {
    $summary = generateReportSummary('garut');
    $current_stock = getCurrentStockReport('garut');
    $stock_movements = getStockMovementHistory('garut', $date_from, $date_to, 20);
} catch (Exception $e) {
...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2"><i class="fas fa-chart-bar"></i> Laporan Stok - Garut</h1>
